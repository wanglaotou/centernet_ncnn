...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--dataset', default='face',
                             help='coco | kitti | coco_hp | pascal | face')
  ...
  def parse(self, args=''):
    ...
    opt.root_dir = '/home/mario/Projects/Obj_det/CenterNet'
    opt.data_dir = '/media/mario/新加卷/DataSets/DSM'
  ...
  def update_dataset_info_and_set_heads(self, opt, dataset):
    ...
    print('heads', opt.heads)       ## train: heads {'hm': 1, 'wh': 2, 'reg': 2}    test: heads {'hm': 1, 'wh': 2, 'reg': 2}
    return opt
